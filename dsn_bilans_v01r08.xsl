...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gipmds="http://www.gip-mds.fr/">
								...
								<xsl:if test="gipmds:rapport/declaration">	
									<xsl:for-each select="gipmds:rapport/declaration">
										...
										<div class="templateTableauConteneur">
											...
											<br/>
											<xsl:if test="declaration_anomalie[ environnement/salarie ]">
												<div class="templateTitreInformation">Anomalie(s) - Salariés</div>
												<br/>
												...
												<xsl:apply-templates select="declaration_anomalie[ environnement/salarie ]"/>
											</xsl:if>

											<br/>
											<xsl:if test="declaration_anomalie[ environnement/individu_non_salarie ]">
												<div class="templateTitreInformation">Anomalie(s) - Individus non salariés </div>
												<br/>
												<xsl:if test="//gipmds:rapport/@type= '20'">
													<table width="800">
														<!--<thead>-->
												...
												<xsl:apply-templates select="declaration_anomalie[ environnement/individu_non_salarie ]"/>
											</xsl:if>
											<br/>
											<xsl:if test="declaration_anomalie[ count(environnement) = 0 ]">
												<div class="templateTitreInformation">Anomalie(s) </div>
												<br/>
												<xsl:if test="//gipmds:rapport/@type= '20'">
													<table width="800">
												...
												<xsl:apply-templates select="declaration_anomalie[ count(environnement) = 0 ]"/>
											</xsl:if>
										</div>										
									</xsl:for-each>
								</xsl:if>
	...
	<!-- Salarie -->
	<xsl:template match="declaration_anomalie[ environnement/salarie ]">
		<strong>Code : </strong>
		<xsl:value-of select="description/code"/>
		<br/>
		<xsl:if test="description/categorie">
		...
		<xsl:if test="environnement">
			...
			<table width="800">
				<tr>
					<xsl:if test="environnement/salarie">
	...
	<!-- Individu non salarie -->
	<xsl:template match="declaration_anomalie[ environnement/individu_non_salarie ]">
		<strong>Code : </strong>
		<xsl:value-of select="description/code"/>
		<br/>
		<xsl:if test="description/categorie">
		...
		<xsl:if test="environnement">
			...
			<table width="800">
				<tr>
					<xsl:if test="environnement/individu_non_salarie">
					<xsl:for-each select="environnement/individu_non_salarie">
						<td width="50%" style="vertical-align: top">
							<strong>Individu non salarié <xsl:value-of select="@origine"/>
							</strong>
							<br/>
							<xsl:if test="NIR">
								<strong>NIR : </strong>
	...
	<!-- Autre anomalie -->
	<xsl:template match="declaration_anomalie[ count(environnement) = 0 ]">
		<strong>Code : </strong>
		<xsl:value-of select="description/code"/>
		<br/>
		<xsl:if test="description/categorie">
