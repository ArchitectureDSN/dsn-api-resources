  ...
  <xsl:template match="/">
        <html>
            <head>
				...
				<link rel="stylesheet" type="text/css" href="css/jspTemplate.css" />								
			</head>			
					...
					<tbody>
						  ...
						  <td class="templateBandeau" colspan="3">
								...
								<div class="templateBandeauBlocTitre">
									<a href="https://www.net-entreprises.fr">
										<div class="templateBandeauTitreImage" style="cursor: pointer"></div>
									</a>
						...
						<tr>
							<td colspan="2">
								<div id="templateBarreHautId" class="templateBarreHaut">
									<span class="label" id="label_declBarreDUCSTitre"></span>
								</div>
							</td>
						...
						<tr>
							<td class="templateBarreGauche" rowspan="2" valign="top">
								<img id="bandeauGauche" src="images/bandeau-gauche.gif" alt="" title="" border="0" />
							</td>
										...
										<tbody>
										  <tr>
												<td nowrap="nowrap" width="50%">
												  <div class="templateTrainEltCourant">
														<a style="background-color: #996699 !important;">
														  <span class="infobulle" id="label_decl_BulleTrainElt2">
																<span class="label" id="label_decl_TrainElt2">
																	<xsl:choose>
																		...
																		<xsl:when test="gipmds:rapport/@type= '22'">Bilan de préparation de la déclaration de l’attestation de salaire pour les arrêts de plus de 6 mois</xsl:when>
																		...
																		<xsl:when test="gipmds:rapport/@type= '61'">Compte-rendu de Déclaration de cotisation et de télérèglement</xsl:when>
																		<xsl:when test="gipmds:rapport/@type= '62'">Compte-rendu de la Déclaration des Données nominatives URSSAF</xsl:when>
																		<xsl:otherwise>
								...
								<div class="templateCorpsSeparateur"/>
								 <xsl:choose>
									<xsl:when test="gipmds:rapport/bordereau">
										<h1 class="titre">Bilan récapitulatif</h1>
										<br />
													...
													<tr>
														<td align="left" valign="top" width="100%" >
														  <div class="templateBlocETB">
																...
																<br/>
																<strong>Code envoi des fichier d'essai ou réel (S10.G00.00.005) :</strong>
																<xsl:choose>
									...
									<xsl:when test="gipmds:rapport/envoi">
										<h1 class="titre">Envoi <xsl:value-of select="gipmds:rapport/envoi/envoi_identification/identifiant"/></h1>
										<br />
										<div class="templateSection">IDENTIFICATION</div>
										<div class="templateTableauConteneur">
										  <table class="templateBlocInformatif" cellpadding="0" cellspacing="0">
										...
										<br />
										<h1 class="titre">Bilan <xsl:value-of select="gipmds:rapport/envoi/envoi_bilan/envoi_etat"/></h1>
										<div class="templateTableauConteneur">
										  <table class="templateBlocInformatif" cellpadding="0" cellspacing="0">
												<tbody>
													<tr>
								...
								<xsl:if test="gipmds:rapport/declaration">	
									...
									<div class="templateTableauConteneur">
										...
										<xsl:if test="declaration_identification/nic_siege">
											<strong>NIC Siége (S21.G00.06.002) :</strong>
							...
							<td class="templateBarreDroite" valign="top">
								<img src="images/ops.gif" alt="" title="" border="0" />
								<br />
								<img src="images/bandeau-variable.gif" alt="" title="" border="0" />
							</td>
						</tr>
						<tr>
